    ...
    (0, _mocha.describe)('Acceptance: Content', function () {
        ...
        (0, _mocha.describe)('as admin', function () {
            ...
            (0, _mocha.beforeEach)(function () {
                ...
                var editor = server.create('user', { roles: [editorRole] });
            ...
            (0, _mocha.it)('displays and filters posts', function () {
                ...
                andThen(function () {
                    ...
                    (0, _chai.expect)(find((0, _emberTestSelectors['default'])('all-filter-link'))).to.have['class']('active');
                    // Not checking request here as it won't be the last request made
                    // Displays all posts + pages
                    (0, _chai.expect)(find((0, _emberTestSelectors['default'])('posts-list-item-id')).length, 'all posts count').to.equal(5);
                });

                click((0, _emberTestSelectors['default'])('drafts-filter-link'));

                andThen(function () {
                    // Filter link is highlighted
                    (0, _chai.expect)(find((0, _emberTestSelectors['default'])('drafts-filter-link'))).to.have['class']('active');
                    ...
                    // Displays draft post
                    (0, _chai.expect)(find((0, _emberTestSelectors['default'])('posts-list-item-id')).length, 'drafts count').to.equal(1);
                    (0, _chai.expect)(find((0, _emberTestSelectors['default'])('posts-list-item-id', draftPost.id)), 'draft post').to.exist;
                });

                click((0, _emberTestSelectors['default'])('published-filter-link'));

                andThen(function () {
                    // Filter link is highlighted
                    (0, _chai.expect)(find((0, _emberTestSelectors['default'])('published-filter-link'))).to.have['class']('active');
                    // API request is correct
                    ...
                    (0, _chai.expect)(find((0, _emberTestSelectors['default'])('posts-list-item-id')).length, 'published count').to.equal(2);
                    (0, _chai.expect)(find((0, _emberTestSelectors['default'])('posts-list-item-id', publishedPost.id)), 'admin published post').to.exist;
                    (0, _chai.expect)(find((0, _emberTestSelectors['default'])('posts-list-item-id', authorPost.id)), 'author published post').to.exist;
                });

                click((0, _emberTestSelectors['default'])('scheduled-filter-link'));

                andThen(function () {
                    // Filter link is highlighted
                    (0, _chai.expect)(find((0, _emberTestSelectors['default'])('scheduled-filter-link'))).to.have['class']('active');
                    // API request is correct
                    ...
                    (0, _chai.expect)(find((0, _emberTestSelectors['default'])('posts-list-item-id')).length, 'scheduled count').to.equal(1);
                    (0, _chai.expect)(find((0, _emberTestSelectors['default'])('posts-list-item-id', scheduledPost.id)), 'scheduled post').to.exist;
                });

                click((0, _emberTestSelectors['default'])('pages-filter-link'));

                andThen(function () {
                    // Filter link is highlighted
                    (0, _chai.expect)(find((0, _emberTestSelectors['default'])('pages-filter-link'))).to.have['class']('active');
                    // API request is correct
                    ...
                    // Displays page
                    (0, _chai.expect)(find((0, _emberTestSelectors['default'])('posts-list-item-id')).length, 'pages count').to.equal(1);
                    (0, _chai.expect)(find((0, _emberTestSelectors['default'])('posts-list-item-id', publishedPage.id)), 'page post').to.exist;
                });

                click((0, _emberTestSelectors['default'])('all-filter-link'));
        ...
        (0, _mocha.describe)('as author', function () {
            ...
            (0, _mocha.it)('only fetches the author\'s posts', function () {
                ...
                andThen(function () {
                    ...
                    (0, _chai.expect)(find((0, _emberTestSelectors['default'])('posts-list-item-id')).length, 'post count').to.equal(1);
                    (0, _chai.expect)(find((0, _emberTestSelectors['default'])('posts-list-item-id', authorPost.id)), 'author post').to.exist;
                });
            });
        });
    });
...
define('ghost-admin/tests/acceptance/settings/general-test', ['exports', 'mocha', 'chai', 'ember-test-selectors', 'jquery', 'ghost-admin/tests/helpers/start-app', 'ghost-admin/tests/helpers/destroy-app', 'ghost-admin/tests/helpers/ember-simple-auth', 'ember-cli-mirage', 'ghost-admin/mirage/config/themes'], function (exports, _mocha, _chai, _emberTestSelectors, _jquery, _ghostAdminTestsHelpersStartApp, _ghostAdminTestsHelpersDestroyApp, _ghostAdminTestsHelpersEmberSimpleAuth, _emberCliMirage, _ghostAdminMirageConfigThemes) {
        ...
        (0, _mocha.describe)('when logged in', function () {
            ...
            (0, _mocha.it)('it renders, shows image uploader modals', function () {
                ...
                andThen(function () {
                    ...
                    (0, _chai.expect)(find('.fullscreen-modal .modal-content .gh-image-uploader .image-url').length, 'url upload').to.equal(1);
                });
                ...
                andThen(function () {
                    (0, _chai.expect)(find('.fullscreen-modal .modal-content .gh-image-uploader .description').text()).to.equal('Upload an image');
                    (0, _chai.expect)(find('.fullscreen-modal .modal-content .gh-image-uploader .image-url').length, 'url upload').to.equal(0);
                });
        ...
        (0, _mocha.describe)('when logged in as admin', function () {
            ...
            (0, _mocha.it)('it renders and navigates correctly', function () {
                ...
                andThen(function () {
                    ...
                    (0, _chai.expect)(find((0, _emberTestSelectors['default'])('user-id')).length, 'user list count').to.equal(3);
            ...
            (0, _mocha.it)('can manage invites', function () {
                ...
                andThen(function () {
                    ...
                    (0, _chai.expect)(find((0, _emberTestSelectors['default'])('user-id')).length, 'initial number of active users').to.equal(1);
                ...
                andThen(function () {
                    ...
                    (0, _chai.expect)(find((0, _emberTestSelectors['default'])('invite-id', '1')).find((0, _emberTestSelectors['default'])('email')).text().trim(), 'displayed email of first invite').to.equal('invite1@example.com');

                    (0, _chai.expect)(find((0, _emberTestSelectors['default'])('invite-id', '1')).find((0, _emberTestSelectors['default'])('role-name')).text().trim(), 'displayed role of first invite').to.equal('Author');

                    // number of users is unchanged
                    (0, _chai.expect)(find((0, _emberTestSelectors['default'])('user-id')).length, 'number of active users after first invite').to.equal(1);
                });
                ...
                andThen(function () {
                    ...
                    (0, _chai.expect)(find((0, _emberTestSelectors['default'])('invite-id', '2')).find((0, _emberTestSelectors['default'])('email')).text().trim(), 'displayed email of second invite').to.equal('invite2@example.com');

                    (0, _chai.expect)(find((0, _emberTestSelectors['default'])('invite-id', '2')).find((0, _emberTestSelectors['default'])('role-name')).text().trim(), 'displayed role of second invite').to.equal('Editor');
                });
                ...
                click((0, _emberTestSelectors['default'])('invite-id', '2') + ' ' + (0, _emberTestSelectors['default'])('revoke-button'));
                ...
                // resend first invite
                click((0, _emberTestSelectors['default'])('invite-id', '1') + ' ' + (0, _emberTestSelectors['default'])('resend-button'));
...
define('ghost-admin/tests/controllers/posts/index.lint-test', ['exports'], function (exports) {
  'use strict';

  describe('ESLint - controllers/posts/index.js', function () {
    it('should pass ESLint', function () {
      // precompiled test passed
    });
  });
...
define('ghost-admin/tests/helpers/ember-basic-dropdown', ['exports', 'ember', 'ember-runloop', 'jquery'], function (exports, _ember, _emberRunloop, _jquery) {
...
define('ghost-admin/tests/integration/components/gh-image-uploader-test', ['exports', 'sinon', 'chai', 'mocha', 'ember-mocha', 'pretender', 'ember-test-helpers/wait', 'ghost-admin/tests/helpers/file-upload', 'jquery', 'ember-runloop', 'ember-service', 'ghost-admin/services/ajax'], function (exports, _sinon, _chai, _mocha, _emberMocha, _pretender, _emberTestHelpersWait, _ghostAdminTestsHelpersFileUpload, _jquery, _emberRunloop, _emberService, _ghostAdminServicesAjax) {
    ...
    (0, _mocha.describe)('Integration: Component: gh-image-uploader', function () {
        ...
        (0, _mocha.it)('defaults to upload form', function () {
            this.render(Ember.HTMLBars.template({
                'id': '5OyTx8bS',
                'block': '{"statements":[["append",["helper",["gh-image-uploader"],null,[["image"],[["get",["image"]]]]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                'meta': {}
        ...
        (0, _mocha.it)('defaults to url form with no filestorage config', function () {
        ...
        (0, _mocha.it)('can switch between form types', function () {
            this.render(Ember.HTMLBars.template({
                'id': '5OyTx8bS',
                'block': '{"statements":[["append",["helper",["gh-image-uploader"],null,[["image"],[["get",["image"]]]]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                'meta': {}
        ...
        (0, _mocha.it)('triggers formChanged action when switching between forms', function () {
            var formChanged = _sinon['default'].spy();
            this.set('formChanged', formChanged);

            this.render(Ember.HTMLBars.template({
                'id': 'l1Z4Epi0',
                'block': '{"statements":[["append",["helper",["gh-image-uploader"],null,[["image","formChanged"],[["get",["image"]],["helper",["action"],[["get",[null]],["get",["formChanged"]]],null]]]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                'meta': {}
            }));
        ...
        (0, _mocha.describe)('file upload form', function () {
        ...
        (0, _mocha.describe)('URL input form', function () {
            beforeEach(function () {
                this.set('configService.fileStorage', false);
            });

            (0, _mocha.it)('displays save button by default', function () {
                this.set('image', 'http://example.com/test.png');
                this.render(Ember.HTMLBars.template({
                    'id': 'Nddjdzwj',
                    'block': '{"statements":[["append",["helper",["gh-image-uploader"],null,[["image","text"],[["get",["image"]],"text test"]]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
            ...
            (0, _mocha.it)('can render without a save button', function () {
                this.render(Ember.HTMLBars.template({
                    'id': 'uKc37rSN',
                    'block': '{"statements":[["append",["helper",["gh-image-uploader"],null,[["image","saveButton","text"],[["get",["image"]],false,"text test"]]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                    'meta': {}
                }));
            ...
            (0, _mocha.it)('fires update action when save button clicked', function () {
                var update = _sinon['default'].spy();
                this.set('update', update);
            ...
            (0, _mocha.it)('fires onInput action when typing URL', function () {
                var onInput = _sinon['default'].spy();
                this.set('onInput', onInput);

                this.render(Ember.HTMLBars.template({
                    'id': 'Hs8416ny',
                    'block': '{"statements":[["append",["helper",["gh-image-uploader"],null,[["image","onInput"],[["get",["image"]],["helper",["action"],[["get",[null]],["get",["onInput"]]],null]]]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                    'meta': {}
                }));
            ...
            (0, _mocha.it)('saves on enter key', function () {
                var update = _sinon['default'].spy();
                this.set('update', update);
...
define('ghost-admin/tests/integration/components/gh-profile-image-test', ['exports', 'chai', 'mocha', 'ember-mocha', 'ember-service', 'ember-runloop', 'pretender', 'ember-test-helpers/wait'], function (exports, _chai, _mocha, _emberMocha, _emberService, _emberRunloop, _pretender, _emberTestHelpersWait) {
    ...
    (0, _mocha.describe)('Integration: Component: gh-profile-image', function () {
        ...
        (0, _mocha.it)('renders and tears down ok with fileStorage:false', function () {
            this.set('fileStorage', false);

            this.render(Ember.HTMLBars.template({
                'id': 'nRoKKbQL',
                'block': '{"statements":[["text","\\n            "],["append",["helper",["gh-profile-image"],null,[["fileStorage"],[["get",["fileStorage"]]]]],false],["text","\\n        "]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                'meta': {}
            }));
...
define('ghost-admin/tests/integration/components/gh-task-button-test', ['exports', 'chai', 'mocha', 'ember-mocha', 'ember-concurrency', 'ember-runloop', 'ember-test-helpers/wait'], function (exports, _chai, _mocha, _emberMocha, _emberConcurrency, _emberRunloop, _emberTestHelpersWait) {
    ...
    (0, _mocha.describe)('Integration: Component: gh-task-button', function () {
        ...
        (0, _mocha.it)('renders', function () {
            this.render(Ember.HTMLBars.template({
                'id': 'Qc/9dMZf',
                'block': '{"statements":[["block",["gh-task-button"],null,null,0]],"locals":[],"named":[],"yields":[],"blocks":[{"statements":[["text","Test"]],"locals":[]}],"hasPartials":false}',
                'meta': {}
            }));
            ...
            this.render(Ember.HTMLBars.template({
                'id': 'Fu4lFCU6',
                'block': '{"statements":[["block",["gh-task-button"],null,[["class"],["testing"]],0]],"locals":[],"named":[],"yields":[],"blocks":[{"statements":[["text","Test"]],"locals":[]}],"hasPartials":false}',
                'meta': {}
            }));
            ...
            this.render(Ember.HTMLBars.template({
                'id': '3YFev2Hb',
                'block': '{"statements":[["block",["gh-task-button"],null,[["disabled"],[true]],0]],"locals":[],"named":[],"yields":[],"blocks":[{"statements":[["text","Test"]],"locals":[]}],"hasPartials":false}',
                'meta': {}
            }));
            ...
            this.render(Ember.HTMLBars.template({
                'id': 'eaHVHPM5',
                'block': '{"statements":[["block",["gh-task-button"],null,[["type"],["submit"]],0]],"locals":[],"named":[],"yields":[],"blocks":[{"statements":[["text","Test"]],"locals":[]}],"hasPartials":false}',
                'meta': {}
            }));
            ...
            this.render(Ember.HTMLBars.template({
                'id': 'sWM4TL0y',
                'block': '{"statements":[["block",["gh-task-button"],null,[["tabindex"],["-1"]],0]],"locals":[],"named":[],"yields":[],"blocks":[{"statements":[["text","Test"]],"locals":[]}],"hasPartials":false}',
                'meta': {}
            }));
        ...
        (0, _mocha.it)('shows spinner whilst running', function (done) {
            ...
            this.render(Ember.HTMLBars.template({
                'id': '/ICFNnTE',
                'block': '{"statements":[["block",["gh-task-button"],null,[["task"],[["get",["myTask"]]]],0]],"locals":[],"named":[],"yields":[],"blocks":[{"statements":[["text","Test"]],"locals":[]}],"hasPartials":false}',
                'meta': {}
            }));
...
define('ghost-admin/tests/integration/components/gh-theme-table-test', ['exports', 'chai', 'mocha', 'ember-mocha', 'jquery', 'sinon', 'ember-runloop'], function (exports, _chai, _mocha, _emberMocha, _jquery, _sinon, _emberRunloop) {
    ...
    (0, _mocha.describe)('Integration: Component: gh-theme-table', function () {
        ...
        (0, _mocha.it)('renders', function () {
            ...
            this.render(Ember.HTMLBars.template({
                'id': 'PKLTnBaa',
                'block': '{"statements":[["append",["helper",["gh-theme-table"],null,[["availableThemes","activateTheme","downloadTheme","deleteTheme"],[["get",["availableThemes"]],["helper",["action"],[["get",[null]],["get",["actionHandler"]]],null],["helper",["action"],[["get",[null]],["get",["actionHandler"]]],null],["helper",["action"],[["get",[null]],["get",["actionHandler"]]],null]]]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                'meta': {}
            }));
        ...
        (0, _mocha.it)('delete link triggers passed in action', function () {
            ...
            this.render(Ember.HTMLBars.template({
                'id': 'gfsD/zjT',
                'block': '{"statements":[["append",["helper",["gh-theme-table"],null,[["availableThemes","activateTheme","downloadTheme","deleteTheme"],[["get",["availableThemes"]],["helper",["action"],[["get",[null]],["get",["actionHandler"]]],null],["helper",["action"],[["get",[null]],["get",["actionHandler"]]],null],["helper",["action"],[["get",[null]],["get",["deleteAction"]]],null]]]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                'meta': {}
            }));
        ...
        (0, _mocha.it)('download link triggers passed in action', function () {
            ...
            this.render(Ember.HTMLBars.template({
                'id': 'VnUhWMaN',
                'block': '{"statements":[["append",["helper",["gh-theme-table"],null,[["availableThemes","activateTheme","downloadTheme","deleteTheme"],[["get",["availableThemes"]],["helper",["action"],[["get",[null]],["get",["actionHandler"]]],null],["helper",["action"],[["get",[null]],["get",["downloadAction"]]],null],["helper",["action"],[["get",[null]],["get",["actionHandler"]]],null]]]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                'meta': {}
            }));
        ...
        (0, _mocha.it)('activate link triggers passed in action', function () {
            ...
            this.render(Ember.HTMLBars.template({
                'id': 'dYJzo20P',
                'block': '{"statements":[["append",["helper",["gh-theme-table"],null,[["availableThemes","activateTheme","downloadTheme","deleteTheme"],[["get",["availableThemes"]],["helper",["action"],[["get",[null]],["get",["activateAction"]]],null],["helper",["action"],[["get",[null]],["get",["actionHandler"]]],null],["helper",["action"],[["get",[null]],["get",["actionHandler"]]],null]]]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                'meta': {}
            }));
...
define('ghost-admin/tests/integration/services/feature-test', ['exports', 'mocha', 'ember-mocha', 'pretender', 'ember-test-helpers/wait', 'ghost-admin/services/feature', 'ember', 'ember-runloop'], function (exports, _mocha, _emberMocha, _pretender, _emberTestHelpersWait, _ghostAdminServicesFeature, _ember, _emberRunloop) {
    ...
    (0, _mocha.describe)('Integration: Service: feature', function () {
        ...
        (0, _mocha.it)('loads labs settings correctly', function (done) {
        ...
        (0, _mocha.it)('returns false for set flag with config false and labs false', function (done) {
        ...
        (0, _mocha.it)('returns true for set flag with config true and labs false', function (done) {
            stubSettings(server, { testFlag: false });
            addTestFlag();
        ...
        (0, _mocha.it)('returns true for set flag with config false and labs true', function (done) {
            stubSettings(server, { testFlag: true });
            addTestFlag();
        ...
        (0, _mocha.it)('returns true for set flag with config true and labs true', function (done) {
            stubSettings(server, { testFlag: true });
            addTestFlag();
        ...
        (0, _mocha.it)('saves correctly', function (done) {
            stubSettings(server, { testFlag: false });
            addTestFlag();
        ...
        (0, _mocha.it)('notifies for server errors', function (done) {
        ...
        (0, _mocha.it)('notifies for validation errors', function (done) {
...
define('ghost-admin/tests/integration/services/lazy-loader-test', ['exports', 'chai', 'mocha', 'ember-mocha', 'pretender', 'jquery'], function (exports, _chai, _mocha, _emberMocha, _pretender, _jquery) {
    ...
    (0, _mocha.describe)('Integration: Service: lazy-loader', function () {
        ...
        (0, _mocha.it)('loads a script correctly and only once', function (done) {
...
define('ghost-admin/tests/unit/controllers/post-settings-menu-test', ['exports', 'ember-runloop', 'rsvp', 'ember-object', 'mocha', 'ember-mocha'], function (exports, _emberRunloop, _rsvp, _emberObject, _mocha, _emberMocha) {

    function K() {
        return this;
    }

    (0, _mocha.describe)('Unit: Controller: post-settings-menu', function () {
        (0, _emberMocha.setupTest)('controller:post-settings-menu', {
...
define('ghost-admin/tests/unit/controllers/settings/navigation-test', ['exports', 'chai', 'mocha', 'ember-mocha', 'ember', 'ghost-admin/models/navigation-item'], function (exports, _chai, _mocha, _emberMocha, _ember, _ghostAdminModelsNavigationItem) {
    var run = _ember['default'].run;
    var EmberObject = _ember['default'].Object;
    ...
    (0, _mocha.describe)('Unit: Controller: settings/navigation', function () {
        (0, _emberMocha.setupTest)('controller:settings/navigation', {
            // Specify the other units that are required for this test.
        ...
        (0, _mocha.it)('action - addItem: adds item to navigationItems', function () {
            var ctrl = this.subject();
        ...
        (0, _mocha.it)('action - addItem: doesn\'t insert new item if last object is incomplete', function () {
            var ctrl = this.subject();
        ...
        (0, _mocha.it)('action - deleteItem: removes item from navigationItems', function () {
            var ctrl = this.subject();
...
define('ghost-admin/tests/unit/models/user-test', ['exports', 'ember-runloop', 'mocha', 'ember-mocha'], function (exports, _emberRunloop, _mocha, _emberMocha) {
    ...
    (0, _mocha.describe)('Unit: Model: user', function () {
        ...
        (0, _mocha.it)('active property is correct', function () {
            var model = this.subject({
                status: 'active'
            });
